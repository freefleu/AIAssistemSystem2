            ...
            <el-form ref="form" :model="form" :inline=true label-width="70px" label-position="left" style="margin-left: 5%">
              <el-row :gutter="10">
                  ...
                  <!--  <el-col :xs="24" :sm="7" :md="7" :lg="8">
                        <el-form-item label="学院" prop="type">
                            <el-select v-model="form.type" clearable filterable placeholder="---请选择---" style="width:175px">
                                <el-option v-for="item in courseTypeList" :value="item.typeId" :label="item.typeName"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col> -->
                </el-row>
                ...
                <el-form-item style="float:right">
                    ...
                    <el-button type="primary" @click="submitForm()">选课</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions({
                saveFormVal: 'changeCourseFormAction',
        ...
        computed: {
            courseTypeList(){
                return this.$store.state.Navi.courseTypeList;
            }
        }
    }
</script>
